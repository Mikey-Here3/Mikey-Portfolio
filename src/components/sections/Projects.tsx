...
const PROJECTS: Project[] = [
    ...
    },
    {
        ...
        description: 'A full-stack academic resource repository built for university students to upload, browse, preview and download past papers, notes, and exam resources. Features role-based admin moderation, PDF preview, Cloudinary storage, JWT authentication, ratings, bookmarks, and comments.',
